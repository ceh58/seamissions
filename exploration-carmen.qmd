...
ggplot(test, aes(x = reorder(flag, -ghg_sum), y = ghg_sum, fill = vessel_class)) +
  geom_col() +
  scale_fill_manual(values = c("#8ed1fc", 
                    ...
                    labels = c("Drifting Longlines",
                               ...
                               "Trawlers",
                               "Tuna Purse Seines")) +
  scale_x_discrete(labels = c("China", "Taiwan", "Russia", "Japan", "Korea")) +
  labs(x = "Country",
       y = "GHG Sum (mt)",
       fill = "Vessel Type",
       title = "Top 5 Emittors by Country and Vessel Type") +
  theme_minimal()
```
